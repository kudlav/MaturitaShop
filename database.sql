...
INSERT INTO `delivery` (`id`, `name`, `price`, `show`, `tooltip`) VALUES
(1, 'Česká pošta', 99, 1, 'Doručení do 2 týdnů.'),
(2, 'PPL', 99, 1, 'Rychlé, spolehlivé a oblíbené.'),
(3, 'Uloženka', 20, 1, '');
...
DELETE FROM `payment`;
INSERT INTO `payment` (`id`, `name`, `price`, `show`, `tooltip`) VALUES
(1, 'Převodem předem', '0', '1', NULL),
(2, 'Kartou online', '99', '1', NULL),
(3, 'Dobírkou při převzetí', '49', '1', NULL);
